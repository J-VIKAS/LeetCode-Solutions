...
//         cout << "inserted root " << preorder[pi] << "\n";
        
//         cout << "left :\n";
//         cout << "inorder : indexes (" << si << "," << ind[preorder[pi]]-1 << ");\n";
//         cout << "preorder : indexes (" << pi+1 << "," << pi+k+1 << ");\n";
        
        root->left = rec(root->left,si,ind[preorder[pi]]-1,inorder,pi+1,pi+k+1,preorder);
        
        // cout << "right :\n";
        // cout << "inorder : indexes (" << ind[preorder[pi]]+1 << "," << se << ");\n";
        // cout << "preorder : indexes (" << pi+k+1 << "," << pe << ");\n";
